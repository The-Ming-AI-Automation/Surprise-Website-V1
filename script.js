...
(function () {
  ...
  const CONFIG = {
    ...
    audio: {
      ...
      voiceMessages: {
        ...
        date: "voice-message.mp3"
      },
      // Fill this in when the music licence requires attribution.
      musicCredit: {
        title: "",
        creator: "",
        license: "",
    ...
    // Edit these values to personalise the final Date Invitation Card.
    dateInvitation: {
  ...
  const copy = {
    en: {
      ...
      birthdayMoment: "A BIRTHDAY WISH", birthdayMakeWish: "Make a wish, caca.",
      ...
      voiceUnavailable: "Couldn’t play the personal message. Upload the configured voice MP3 to the repository root."
    },
    bm: {
      ...
      birthdayMoment: "SATU HARAPAN HARI JADI", birthdayMakeWish: "Buat satu harapan, caca.",
      ...
      voiceUnavailable: "Mesej peribadi tidak dapat dimainkan. Muat naik fail MP3 suara yang ditetapkan ke root repositori."
    },
    zh: {
      ...
      birthdayMoment: "一个生日愿望", birthdayMakeWish: "许个愿吧，caca。",
      ...
      voiceUnavailable: "无法播放语音留言。请把设定的语音 MP3 上传到仓库根目录。"
    }
  };
  ...
  function populateDateInvitation() {
    ...
    document.querySelector("#ticket-recipient").textContent = CONFIG.recipient;
  ...
  voiceButton.addEventListener("click", async () => {
    ...
    const source = CONFIG.audio.voiceMessages[selectedJourney] || CONFIG.audio.voiceMessages.love;
    if (!source) {
