...
(function () {
  ...
  function applyJourneyContent() {
    const source = selectedJourney === "birthday" ? birthdayCopy[language] : copy[language];
    ...
    const memorySet = selectedJourney === "birthday" ? birthdayMemories : loveMemories;
  ...
  function chooseJourney(journey) {
    ...
    document.querySelector(`#${journey === "birthday" ? "birthday" : "heart"}-choice`).classList.add("active-choice");
    applyJourneyContent();
    heartOpacity = 0.92;
    moveParticles(journey === "birthday" ? "cake" : "heart", 1100);
  ...
  document.querySelector("#finale-button").addEventListener("click", () => {
    ...
    heartOpacity = 0.88;
    moveParticles(selectedJourney === "birthday" ? "cake" : "heart", 2100);
  });
